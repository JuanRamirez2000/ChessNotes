...
export default function AnalysisCard({
  ...
  return (
    <>
      ...
      />
      <div className="flex flex-col items-center rounded-lg bg-slate-900 p-2 text-cyan-100 shadow-lg hover:cursor-pointer">
        ...
        <div className="mt-1 flex w-full flex-row justify-between">
          <button
            ...
            className="text-md flex w-40 flex-row items-center justify-start gap-2 rounded-md border-b-8 border-b-emerald-900 bg-emerald-400 p-2 font-semibold text-cyan-100 active:border-b"
          >
